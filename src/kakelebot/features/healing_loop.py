    ...
    def run(
        ...
        while True:
            ...
            last_cycle = self._healing_runtime.execute_cycle(
                ...
                secondary_attack_allowed_target_texts=profile.combat.secondary_attack_allowed_target_texts,
                secondary_attack_blocked_target_texts=profile.combat.secondary_attack_blocked_target_texts,
                secondary_attack_require_target_text_match=profile.combat.secondary_attack_require_target_text_match,
