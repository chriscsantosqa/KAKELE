...
from kakelebot.ui.snapshot_utils import (
    manual_snapshot_comparison_assessment,
    manual_snapshot_comparison_summary,
    ocr_preview_payload,
    roi_ratio_payload,
    screen_region_payload,
    short_snapshot_text,
    snapshot_assessment,
...
class MainWindow:
    ...
    def _screen_region_payload(region) -> dict | None:
        return screen_region_payload(region)

    @staticmethod
    def _roi_ratio_payload(region) -> dict:
        return roi_ratio_payload(region)

    @staticmethod
    def _ocr_preview_payload(preview) -> dict | None:
        return ocr_preview_payload(preview)

    @staticmethod
    def _target_preview_payload(preview) -> dict | None:
        return target_preview_payload(preview)
    ...
    def _short_snapshot_text(text: str | None, max_length: int = 24) -> str:
        return short_snapshot_text(text, max_length)

    @staticmethod
    def _snapshot_change_summary(comparison: dict) -> str:
        return snapshot_change_summary(comparison)

    @staticmethod
    def _snapshot_assessment(metadata: dict) -> str:
        return snapshot_assessment(metadata)

    @staticmethod
    def _manual_snapshot_comparison_summary(primary: dict, secondary: dict) -> str:
        return manual_snapshot_comparison_summary(primary, secondary)

    @staticmethod
    def _manual_snapshot_comparison_assessment(primary: dict, secondary: dict) -> str:
        return manual_snapshot_comparison_assessment(primary, secondary)
